...
const OtherWebinars = () => {
    return (<section className="project-2 pt-115 pb-90 fix">
        <div className="container">
            <div className="row align-items-center justify-content-center">
                <div className="col-lg-8">
                    <div className="section-title-wrapper mb-50 text-center">
                        <h5 className="section-subtitle mb-20">Most Recent</h5>
                        <h2 className="section-title">Courses & Webinars</h2>
                    </div>
                </div>
            </div>
            <div className="row">
